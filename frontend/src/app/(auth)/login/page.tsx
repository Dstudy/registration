...
export default function LoginPage() {
  ...
  return (
    <div
      className={clsx(
        styles.background,
        "relative min-h-screen overflow-hidden flex items-center justify-center bg-brand-bg p-4",
      )}
    >
        ...
        <div className="flex flex-col items-center text-center gap-10">
          ...
          <div>
            <h1 className="text-xl font-bold text-brand-blue leading-snug">
              Hệ thống quản lý
              <br />
              lịch làm việc Thư viện Dương Liễu
            </h1>
            <p className="text-sm text-gray-500 mt-2">
              Vui lòng đăng nhập bằng mã TNV
            </p>
          </div>
